...
public class PodcastListAdapter2 extends BaseAdapter {
	...
	public PodcastListAdapter2(Context context, int layout, Cursor cursor) {
	...
	public long getItemId(int position) {
		...
		return cursor.getLong(cursor.getColumnIndex(PodcastColumns._ID));
	}
